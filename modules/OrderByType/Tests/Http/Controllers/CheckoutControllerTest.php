...
namespace Modules\OrderByType\Tests\Http\Controllers;
...
use Modules\OrderByType\Checkout\OrderReceived;
use Modules\OrderByType\Checkout\OrderStarted;
use Modules\OrderByType\Models\Order;
use Modules\OrderByType\Tests\OrderTestCase;
...
class CheckoutControllerTest extends OrderTestCase
{
    ...
    public function it_successfuly_creates_an_order(): void
    {
        ...
        foreach ($products as $product) {
            /** @var \Modules\OrderByType\OrderLine $orderLine */
